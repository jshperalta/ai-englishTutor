...
class TranslateWorker(QObject):
    ...
    def run(self):
        self.progress.emit(" ","You can translate English words to Filipino and vise versa. ")
        speak("You can translate English words to Filipino and vise versa. ")
        self.progress.emit(" ","Try saying: translate kumusta")
